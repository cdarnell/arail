...
| [`video-games-world-build.md`](./video-games-world-build.md) | Build the Video Games World: Layer A a themed, source-grounded gaming World (shippable alone); Layer B the measured "optimal config for your hardware" autoresearch; Layer C optional consent-gated driver/release scouting. Layer A shipped: `lab/worlds/video-games/`; see [`docs/experience/video-games-world.md`](../experience/video-games-world.md). |
